...
mysql_select_db($database_PetShop, $ConnPetShop);
$query_rsRelacaoUltimasNoticias = "SELECT * FROM noticias WHERE not_id = '29'";
...
<!-- saved from url=(0055)file:///F:/pet%20shop/Categorias/passaros/passaros.html -->
    	...
    	<div class="sidebar_box"><span class="bottom"></span> 
          ...
          <div class="content"> 
            <ul class="sidebar_list">
              <li><a href="gatos.htm">Gatos</a></li>
...
<!-- Slideshow HTML -->
          ...
          <div id="slidesContainer"> 
            <div class="slide"> 
              <div class="product_box"> <a href="../../leitor_noticia.php?not_id=<?php echo $row_rsRelacaoUltimasNoticias['not_id']; ?>">
                <img src="Areia-Silica-Chalesco.jpg" alt="Gatos" width="160" height="160"></a> 
                <h3>Areia Silica Chalesco</h3>
                <p class="product_price">R$ 12,90</p>
              ...
              <div class="product_box"> <a href="Categorias/passaros/productdetail.html"> 
                <img src="fonteparagatosfengshui4.jpg" alt="Gatos" width="160" height="160"></a> 
                <h3>Fonte Bebedouro Pioneer Pet Feng Shui Smart Cat - 1,7 Litros</h3>
                <p class="product_price">R$ 40,10 </p>
                <p class="add_to_cart"> <a href="Categorias/passaros/produtos/Ra%C3%A7%C3%A3oWhiskasParaAdultoDeCarne.html">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
                <br>
              </div>
              <div class="product_box"> <a href="Categorias/passaros/productdetail.html"> 
                <img src="BolinhasPlasticaComGuizoParaGatos.jpg" alt="Gatos" width="160" height="160"></a> 
                <h3>Bolinhas Plástica Com Guizo para Gatos</h3>
                <p class="product_price">R$ 2,30</p>
                <p class="add_to_cart"> <a href="/Categorias/passaros/produtos/CasaCatCaveComAlmofada.html">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
                <br>
              </div>
            ...
            <div class="slide"> 
              <div class="product_box no_margin_right"> <a href="Categorias/passaros/productdetail.html"> 
                <img src="CasaCatCaveRosaAlmofadaRosaSoft.jpg" alt="Gatos" width="160" height="160"></a> 
                <h3>Casa Cat Cave com Almofada</h3>
                <p class="product_price">R$ 148,40</p>
                <p class="add_to_cart"> <a href="Categorias/passaros/BolinhasPl%C3%A1sticaComGuizoParaGatos.html">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
              </div>
              <div class="product_box no_margin_right"> <a href="categorias/passaros/productdetail.html"> 
                <img src="Ratinho_Vinil.jpg" alt="Gatos" width="160" height="160"></a> 
                <h3>Ratinho Vinil - 1 Unidade</h3>
                <p class="product_price">R$ 2,18</p>
                <p class="add_to_cart"> <a href="Categorias/passaros/productdetail.html">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
              </div>
            </div>
  ...
  <br> <br><br> <br><br> <br>
    	...
    	<div class="blank_box">
        	<a href="Categorias/passaros/passaros.html#"><img src="../../images/rodape.jpg" alt=""></a>
        </div>    
    </div>
...
<div id="templatemo_footer">
	...
	<a href="../../faqs.php">Dúvidas</a> | <a href="../../about.php">Desenvolvedores</a></p>
