...
mysql_select_db($database_PetShop, $ConnPetShop);
$query_rsRelacaoUltimasNoticias = "SELECT * FROM noticias WHERE not_id = '30'";
    	...
    	<div class="sidebar_box"><span class="bottom"></span> 
          ...
          <div class="content"> 
            <ul class="sidebar_list">
              ...
              <li><a href="passaros.php">Pássaros</a></li>
            ...
            <div id="slideInner"> 
              <div class="slide"> 
                <div class="product_box"><a href="../../leitor_noticia.php?not_id=<?php echo $row_rsRelacaoUltimasNoticias['not_id']; ?>">
                  <img src="Porta_Ninho_Mr_Pet_especial_com_carpete.jpg" alt="Pássaros" width="160" height="160"></a> 
                  <h3>Porta Ninho Mr Pet Especial Com Carpete</h3>
                ...
                <div class="product_box"> <a href="Categorias/passaros/productdetail.html"> 
                  <img src="Alimento_Zootekna_Barrita_Periquito_60g.jpg" alt="Pássaros" width="160" height="160"></a> 
                  <h3>Alimento Zootekna Barrita Periquito 60g</h3>
                  <p class="product_price">R$ 38,90</p>
                ...
                <div class="product_box"> <a href="Categorias/passaros/productdetail.html"> 
                  <img src="Kit_Vida_Para_Passaros_Mr_Pet%20-Grande.jpg" alt="Pássaros" width="160" height="160"></a> 
                  <h3>Kit Vida para Pássaros Mr Pet - Grande</h3>
                  <p class="product_price">R$ 12,72</p>
              ...
              <div class="slide"> 
                <div class="product_box no_margin_right"> <a href="Categorias/passaros/productdetail.html"> 
                  <img src="Racoo_Alcon_Eco_Club.jpg"  alt="Pássaros" width="160" height="160"></a> 
                  <h3>Ração Alcon Eco Club para Calopsita - 310gr</h3>
                  <p class="product_price">R$ 15,90</p>
                  <p class="add_to_cart"> <a href="Categorias/passaros/BolinhasPl%C3%A1sticaComGuizoParaGatos.html">+Detalhes</a> 
                    <!--<a href="shoppingcart.html">+Carrinho</a>-->
                  </p>
                </div>
                <div class="product_box no_margin_right"> <a href="categorias/passaros/productdetail.html"> 
                  <img src="Bebedouro_Duki_Neon_Automatico.jpg" alt="Pássaros" width="160" height="160"></a> 
                  <h3>Bebedouro Duki Neon Automático</h3>
                  <p class="product_price">R$ 38,90</p>
