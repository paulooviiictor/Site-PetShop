...
mysql_select_db($database_PetShop, $ConnPetShop);
$query_rsRelacaoUltimasNoticias = "SELECT * FROM noticias WHERE not_id = '32'";
...
<!-- saved from url=(0055)file:///F:/pet%20shop/Categorias/roedores/roedores.html -->
...
<div id="templatemo_main">
    	...
    	<div class="sidebar_box"><span class="bottom"></span> 
          ...
          <div class="content"> 
            <ul class="sidebar_list">
              ...
              <li><a href="../peixes/peixes.php">Peixes</a></li>
    ...
    <div id="content" class="right">
		<h2>Seção Para Roedores</h2>
        <p>
		</p><h4>Temos os mais diferentes roedores, confira!</h4>
		<p></p>
		<br> <br>
<br>
...
<!-- Slideshow HTML -->
        <div id="slideshow"> 
          <div id="slidesContainer"> 
            <div class="slide"> 
              <div class="product_box"><a href="../../leitor_noticia.php?not_id=<?php echo $row_rsRelacaoUltimasNoticias['not_id']; ?>"> <img src="Alicate-Unha-Guilhotina-Cabo-emborrachado.jpg" alt="Roedores" width="160" height="160"></a> 
                <h3>Alicate De Unha Guilhotina</h3>
                <p class="product_price">R$ 10,90</p>
              ...
              <div class="product_box"> <a href="../../productdetail.html"><img src="Globo_de_Exercicio_Hamster.jpg" alt="Roedores" width="160" height="160"></a> 
                <h3>Globo De Exercício Hamster</h3>
                <p class="product_price">R$ 25,59</p>
                <p class="add_to_cart"> <a href="file:///F:/pet%20shop/Categorias/roedores/produtos/Ra%C3%A7%C3%A3oWhiskasParaAdultoDeCarne.html">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
                <br>
              </div>
              <div class="product_box"> <a href="../../productdetail.html"><img src="Racao_Especial_para_Hamster.jpg" alt="Roedores" width="160" height="160"></a> 
                <h3>Ração Especial Para Hamster</h3>
                <p class="product_price">R$ 6,14</p>
                <p class="add_to_cart"> <a href="file:///F:/pet%20shop/Categorias/roedores/produtos/CasaCatCaveComAlmofada.html">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
                <br>
              </div>
            ...
            <div class="slide"> 
              <div class="product_box no_margin_right"> <a href="../../productdetail.html"><img src="Racao_Zoofood_para_Hamster_350gr.jpg" alt="Roedores" width="160" height="160"></a> 
                <h3>Ração Zoo food Hamster</h3>
                <p class="product_price">R$ 13,90</p>
                <p class="add_to_cart"> <a href="file:///F:/pet%20shop/Categorias/roedores/BolinhasPl%C3%A1sticaComGuizoParaGatos.html">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
              </div>
              <div class="product_box no_margin_right"> <a href="../../productdetail.html"><img src="Saco_de_Dormir_para_Ferrets_e_Furao.jpg" alt="Roedores" width="160" height="160"></a> 
                <h3>Rede Para Ferrets e Furão</h3>
                <p class="product_price">R$ 3,90</p>
                <p class="add_to_cart"> <a href="file:///F:/pet%20shop/Categorias/roedores/productdetail.html">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
              </div>
            </div>
   ...
   <br><br> <br> <br><br> <br> <br><br> <br>
    	...
    	<div class="blank_box">
        	<a href="../../roedores.html#"><img src="../../images/rodape.jpg" alt=""></a>
        </div>    
    </div>
