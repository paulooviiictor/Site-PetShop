...
<!-- saved from url=(0066)file:///F:/pet%20shop/Categorias/animaisexot/animais_exoticos.html -->
...
<div id="templatemo_main">
	<div id="sidebar" class="left">
          ...
          <div class="content"> 
            <ul class="sidebar_list">
              ...
              <li><a href="../resgatando_vidas/resgatandovidas.php">Resgatando 
                Vidas</a></li>
              <li><a href="animais_exoticos.php">Animais Exóticos</a></li>
        ...
        <div class="sidebar_box"><span class="bottom"></span> 
          ...
          <div class="content special"> <img src="../../images/especial/images%20(1).jpg" alt="Casal de Pombas"> 
            <a href="file:../../Categorias/animaisexot/animais_exoticos.html#">Casal 
            de Pombas Rosa</a> 
    ...
    <div id="content" class="right">
		<h2>Animais Exóticos</h2>
        <p>
		</p><h4>Nossa galeria de animais exóticos proporciona aos nossos clientes os mais diferentes bichanos. Confira!</h4>
		<p></p>
		<br> <br>
<br>
...
<!-- Slideshow HTML -->
        <div id="slideshow"> 
          <div id="slidesContainer"> 
            <div class="slide"> 
              <div class="product_box"> <a href="../../productdetail.html"> <img src="exot3.png" alt="Camaleão" width="160" height="160"></a> 
                <h3>Camaleão</h3>
                <p class="product_price">R$ 120</p>
                <!--
            <p class="add_to_cart">
                <!--<a href="productdetail.html">+Detalhes</a>-->
                <!--<a href="shoppingcart.html">+Carrinho</a>
            </p>-->
              </div>
              <div class="product_box"> <a href="../../Categorias/animaisexot/productdetail.html"><img src="exot4.jpg" alt="Esquilos" width="160" height="160"></a> 
                <h3>Filhotes de Esquilos</h3>
              ...
              <div class="product_box"> <a href="../../Categorias/animaisexot/productdetail.html"><img src="exot2.jpg" alt="Falsa Coral" width="160" height="160"></a> 
                <h3>Cobra Falsa Coral</h3>
                <p class="product_price">R$ 500</p>
                <!--<p class="add_to_cart">
                a href="productdetail.html">+Detalhes</a>
                <a href="shoppingcart.html">+Carrinho</a>
            </p>-->
            ...
            <div class="slide" style="float: left; width: 560px;"> 
              <div class="product_box no_margin_right"> <a href="../../Categorias/animaisexot/productdetail.html"><img src="exot1.jpg" alt="Tartaruga Marinha" width="160" height="160"></a> 
        ...
        <p align="center">Entre em contato conosco:  <a href="mailto:ellenmenezespes@gmail.com">ellenmenezespes@gmail.com</a></p>
  </div>
  ...
  <br> <br><br> <br><br> 
    	...
    	<div class="blank_box">
        	<a href="../../Categorias/animaisexot/animais_exoticos.html#"><img src="../../images/rodape.jpg" alt=""></a>
        </div>    
    </div>
...
<div id="templatemo_footer">
	...
	<div class="footer_right">
	  <p><a href="../../index.php">Home</a> | <a href="../../products.php">Produtos</a> 
        | <a href="../../galeria.php">Galeria</a> | <a href="../../checkout.php">Cadastro</a> 
        | <a href="../../contact.php">Contatos</a> | <a href="../../faqs.php">Dúvidas</a> 
