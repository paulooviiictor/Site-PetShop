...
<!-- saved from url=(0069)file:///F:/pet%20shop/Categorias/resgatandovidas/resgatandovidas.html -->
...
<div id="templatemo_header_wsp">
	<div id="templatemo_header" class="header_subpage"> 
      <div id="site_title"><a href="../../Categorias/resgatandovidas/resgatandovidas.html#"></a></div>
...
<div id="templatemo_main">
	<div id="sidebar" class="left">
    	<div class="sidebar_box"><span class="bottom"></span> 
          ...
          <div class="content"> 
            <ul class="sidebar_list">
              ...
              <li><a href="resgatandovidas.php">Resgatando Vidas</a></li>
        ...
        <div class="sidebar_box"><span class="bottom"></span> 
          ...
          <div class="content special"> <img src="../../images/especial/images%20(1).jpg" alt="Casal de Pombas"> 
            <a href="../../Categorias/resgatandovidas/resgatandovidas.html#">Casal 
            de Pombas Rosa</a> 
    ...
    <div id="content" class="right">
		<h2>Resgatando Vidas</h2>
        <p>Resgatando Vidas é um projeto voltado para animais abandonados, tanto domésticos como silvestres.  Este projeto não se trata de uma ONG, não recebe ajuda governamental e funciona através de minha comunicação com os meus clientes através de e-mails e também aqui pelo site. Se souber de algum animal que esteja abandonado ou sofrendo maltrato, avise-nos! Porém caso esteja aqui para ajudar com ração, produtos de limpeza, cobertores e outros, quem sabe se tornar uma madrinha ou padrinho será maravilhoso e desde já agradeço!</p>
		<p>Fale conosco por esse e-mail : ellenmenezespes@gmail.com</p>
		<br>
		 <h2 align="center"></h2>
<!-- Slideshow HTML -->
        <div id="slideshow"> 
          <div id="slidesContainer"> 
            <div class="slide"> 
              <div class="product_box"> <a href="file:///F:/pet%20shop/Categorias/resgatandovidas/productdetail.html"><img src="gatos3.jpg" alt="Cama Aquário" width="160" height="160"></a> 
                <!-- <h3>Cama Aquario</h3> -->
                <!-- <p class="product_price">R$ 530</p>
            <p class="add_to_cart">
                <a href="../../Categorias/resgatandovidas/productdetail.html">+Detalhes</a> -->
                <!--<a href="shoppingcart.html">+Carrinho</a>-->
                <!--  </p> -->
              </div>
              <div class="product_box"> <a href="../../Categorias/resgatandovidas/productdetail.html"><img src="dog1.jpg" alt="Casa com Almofada" width="160" height="160"></a> 
            ...
            <p class="add_to_cart">
              ...
              <div class="product_box"> <a href="../../Categorias/resgatandovidas/productdetail.html"><img src="dog3.jpg" alt="Mini Caverna" width="160" height="160"></a> 
                <!-- <h3>Mini Caverna para Répteis</h3> -->
                <!-- <p class="product_price">R$ 76,98</p>
            <p class="add_to_cart">
                 <a href="../../Categorias/resgatandovidas/productdetail.html">+Detalhes</a> -->
                <!--<a href="shoppingcart.html">+Carrinho</a>-->
                <!-- </p> -->
