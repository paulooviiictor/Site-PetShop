...
<div id="templatemo_main">
    ...
    <div id="content" class="right">
		<h2>Adoções</h2>
        <p>
		</p><h4> <p align="center">Entre em contato conosco:  <a href="mailto:ellenmenezespes@gmail.com">ellenmenezespes@gmail.com</a></p></h4>
		<p></p>
		<br> <br>
<br>
...
<!-- Slideshow HTML -->
        <div id="slideshow"> 
          <div id="slidesContainer"> 
            <div class="slide"> 
              <div class="product_box"> <img src="dog3.jpg" alt="Adoções" width="160" height="160"> 
                <!-- <h3></h3> -->
                <br>
              </div>
              <div class="product_box"> <img src="gatos1.jpg" alt="Adoções" width="160" height="160"> 
                <!--  <h3></h3> -->
                <br>
              </div>
              <div class="product_box"> <img src="gatos3.jpg"  alt="Adoções" width="160" height="160"> 
                <!-- <h3></h3> -->
                <br>
              </div>
            </div>
            <div class="slide"> 
              <div class="product_box no_margin_right"> <img src="dog2.jpg"  alt="Adoções" width="160" height="160"> 
                <!--  <h3></h3> -->
                <br>
              </div>
              <div class="product_box no_margin_right"> <img src="gatos4.jpg" alt="Adoções" width="160" height="160"> 
                <!--  <h3></h3> -->
                <br>
              </div>
            </div>
