...
$query_rsRelacaoUltimasNoticias = "SELECT * FROM noticias WHERE not_status = 'ON' ORDER BY not_id DESC";
...
mysql_select_db($database_PetShop, $ConnPetShop);
$query_rsLeitorNoticia = ("SELECT *, date_format(not_data, '%d/%m/%Y') AS not_data FROM noticias WHERE not_id=" .$_GET['not_id']. " AND noticias.not_status = 'ON'");
$rsLeitorNoticia = mysql_query($query_rsLeitorNoticia, $ConnPetShop) or die(mysql_error());
...
<div id="templatemo_main">
    ...
    <div id="content" class="right">
		<h2><?php echo $row_rsLeitorNoticia['not_titulo']; ?></h2>
        
		<p style=" position:relative; "><?php echo $row_rsLeitorNoticia['not_conteudo']; ?></p>
