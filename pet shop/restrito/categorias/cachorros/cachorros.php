...
<!-- Slideshow HTML -->
        <div id="slideshow"> 
          <div id="slidesContainer"> 
            <div class="slide"> 
              <div class="product_box"> <a href="../../leitor_noticia.php?not_id=<?php echo $row_rsRelacaoUltimasNoticias['not_id']; ?>"><img src="Alimentador_Eletrônico_e_Programável_Premium_Chalesco.jpg" alt="Cães" width="160" height="160"></a> 
                <h3>Alimentador Eletrônico e Programável Premium Chalesco</h3>
                <p class="product_price">R$ 199,90</p>
              ...
              <div class="product_box"> <a href="#"> <img src="Bebedouro_Portátil_para_Cães_Fresh_Dog.jpg"width="160" height="160"></a> 
                <h3>Bebedouro Portátil Para Cães Fresh Dog</h3>
                <p class="product_price">R$ 8,47</p>
                <p class="add_to_cart"> <a href="#">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
                <br>
              </div>
              <div class="product_box"> <a href="#"> <img src="Cama_T-Bone_Beringer.jpg" alt="Cães" width="160" height="160"></a> 
                <h3>Cama T-Bone Beringer</h3>
                <p class="product_price">R$ 118,35</p>
                <p class="add_to_cart"> <a href="#">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
                <br>
            ...
            <div class="slide"> 
              <div class="product_box no_margin_right"> <a href="#"> <img src="Limpa_Patinhas_230ml.jpg" alt="Cães" width="160" height="160"></a> 
                <h3>Limpa Patinhas 230ml</h3>
                <p class="product_price">R$ 20,68</p>
                <p class="add_to_cart"> <a href="#">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
              </div>
              <div class="product_box no_margin_right"> <a href="#"> <img src="Comedouro_Duplo_Inox_com_Suporte.jpg" alt="Cães" width="160" height="160"></a> 
                <h3>Comedouro Duplo Inox Com Suporte</h3>
                <p class="product_price">R$ 22,90</p>
                <p class="add_to_cart"> <a href="#">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
              </div>
