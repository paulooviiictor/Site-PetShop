	...
	<div id="templatemo_header" class="header_subpage"> 
      ...
      <div id="templatemo_menu" class="ddsmoothmenu"> 
        <ul>
          ...
          <li><a href="galeria.php"class="selected">Galeria</a></li>
  ...
  <!-- Slideshow HTML -->
        <div id="slideshow2"> 
          <div id="slidesContainer2"> 
            <div id="slideInner2"> 
              <div class="slide2"> 
                <div class="product_box no_margin_right"> <a href="galeria/images.jpg"  rel="lightbox[galeria]"> 
                  <img src="galeria/images.jpg" alt="Imagem 1" width="160" height="160"/></a> 
                  <!--  <h3></h3> -->
                </div>
                <div class="product_box"> <a href="galeria/images2.jpg"  rel="lightbox[galeria]"> 
                  <img src="galeria/images2.jpg"  alt="Imagem 2" width="160" height="160" /></a> 
                  <!--  <h3></h3> -->
                </div>
                <div class="product_box"> <a href="galeria/images3.jpg" rel="lightbox[galeria]"> 
                  <img src="galeria/images3.jpg"  alt="Imagem 3" width="160" height="160"/></a> 
                  <!--  <h3></h3> -->
                </div>
              </div>
              <div class="slide2"> 
                <div class="product_box"> <a href="galeria/images4.jpg"  rel="lightbox[galeria]"> 
                  <img src="galeria/images4.JPG" alt="Imagem 4" width="160" height="160"/></a> 
                  <!-- <h3></h3> -->
                </div>
                <div class="product_box"> <a href="galeria/images5.jpg"  rel="lightbox[galeria]"> 
                  <img src="galeria/images5.jpg" alt="Imagem 5" width="160" height="160"/></a> 
                  <!-- <h3></h3> -->
                </div>
              </div>
            </div>
