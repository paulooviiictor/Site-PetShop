...
mysql_select_db($database_PetShop, $ConnPetShop);
$query_rsRelacaoUltimasNoticias = "SELECT * FROM noticias WHERE not_id = '1'";
...
mysql_select_db($database_PetShop, $ConnPetShop);
$query_rsRelacaoUltimasNoticias2 = "SELECT * FROM noticias WHERE not_id = '1'";
...
<div class="windows-popup">
    ...
    <form method="post" name="contact" action="#">
      <div class="col col13"> 
        ...
        <input name="nome" type="text" class="input_field" id="name" maxlength="40" />
      ...
      <br>
      <div class="cleaner h10"></div>
      <input type="submit" class="submit_btn left" name="submit" id="submit" value="Entrar" />
    </form>
		  <br><br>
    ...
    <div id="content" class="right">
        ...
        <div id="slideshow"> 
          <div id="slidesContainer"> 
            <div class="slide"> 
              <div class="product_box"> <a href="productdetail.html"><img src="images/product/brinquedo2.jpg" alt="flowers 2" /></a> 
                <h3><br>
              ...
              <div class="product_box"> <a href="productdetail.html"><img src="images/product/aquario1.jpg" alt="floral set 5" /></a> 
                <h3>Aquário Natureza Selvagem</h3>
                <p class="product_price">R$150</p>
                <p class="add_to_cart"> <a href="productdetail.html">+Detalhes</a> 
                  <!--<a href="shoppingcart.html">+Carrinho</a>-->
                </p>
              </div>
              <div class="product_box"> <a href="productdetail.html"><img src="images/product/racao1.jpg" alt="flowers 7" /></a> 
            ...
            <div class="slide"> 
              <div class="product_box"> <a href="productdetail.html"><img src="images/product/brinquedo3.jpg" alt="floral 3" /></a> 
                <h3><br>
              ...
              <div class="product_box no_margin_right"> <a href="productdetail.html"><img src="images/product/brinquedo1.jpg" alt="flowers 4" /></a> 
                <h3><br>
              ...
              <div class="product_box"> <a href="productdetail.html"><img src="images/product/gaiola2.jpg" alt="floral set 1" /></a> 
  ...
  <!-- Slideshow HTML -->
        <div id="slideshow2"> 
          <div id="slidesContainer2"> 
            <div id="slideInner2"> 
              <div class="slide2"> 
                <div class="product_box"> <a href="productdetail.html"><img src="images/product/UnhaPosti%C3%A7aParaGatos.jpg" alt="Unha Postiça"></a> 
                  <h3><br>
                ...
                <div class="product_box"> <a href="productdetail.html"><img src="images/product/VermífugoDrontalGatos.jpg" alt="Remédio Vermífogo"></a> 
                  <h3>Vermífogo Dontral Para Gatos</h3>
                  <p class="product_price">R$80</p>
                  <p class="add_to_cart"> <a href="file:///F:/pet%20shop/productdetail.html">+Detalhes</a> 
                    <!--<a href="shoppingcart.html">+Carrinho</a>-->
                  </p>
                </div>
                <div class="product_box"> <a href="productdetail.html"><img src="images/product/principe.jpg" alt="flower set 6" /></a> 
              ...
              <div class="slide2"> 
                <div class="product_box"> <a href="productdetail.html"><img src="images/product/pedigree.jpg" alt="floral 8" /></a> 
                ...
                <div class="product_box"> <a href="productdetail.html"><img src="images/escovatirapelofurminator.jpg"  alt="floral 8" /></a> 
                ...
                <div class="product_box"> <a href="productdetail.html"><img src="images/gaiolaparaperiquito.jpg"  alt="floral 8" /></a> 
