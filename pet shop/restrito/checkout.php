	...
	<div id="templatemo_header" class="header_subpage"> 
      ...
      <div id="templatemo_menu" class="ddsmoothmenu"> 
        <ul>
          ...
          <li><a href="checkout.php" class="selected">Cadastro</a></li>
    ...
    <div id="content" class="right">
    	<h2>Cadastro</h2>
			...
			<form method="POST" action="cadastro.php">
				Nome completo :
				<input type="text" name="login" id="fullname" maxlength="40"/> 
				Senha:
				<input type="password" name="senha" id="senha" maxlength="40">
                Endereço:
      			<input name=" Endereco" type="text" id="address" maxlength="40" />
				
            </div>
            
            <div class="content_half right form_field">
				<input type="submit" value="Cadastrar" id="submit" name="cadastrar" class="submit_btn left"/>
				  </form>
			  </div></div>
